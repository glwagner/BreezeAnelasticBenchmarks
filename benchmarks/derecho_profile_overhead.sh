#!/bin/bash
#PBS -A UMIT0049
#PBS -N profile-overhead
#PBS -j oe
#PBS -q main
#PBS -l walltime=00:30:00
#PBS -l select=1:ncpus=64:mpiprocs=1:ngpus=1:gpu_type=a100:mem=384GB

# Profile distributed vs non-distributed overhead on a single GPU.
# This script runs both architectures on the same GPU to compare.
...
# Don't set JULIA_CUDA_MEMORY_POOL=none for single-GPU profiling
# (pool=none can cause OOM during compilation)
...
mpiexec -n 1 -ppn 1 \
    ...
    benchmarks/profile_distributed_overhead.jl
